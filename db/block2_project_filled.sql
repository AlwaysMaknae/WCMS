...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 26, 2019 at 04:42 PM
...
('<h1>Balloon Rides</h1>', '1', '1', '2', '<form action=\"core\" method=\"POST\"><label>INFORMATION</label><br><input type=\"text\" name=\"name\" placeholder=\"Name\"><br><input type=\"email\" name=\"email\" placeholder=\"Email\"><br><input type=\"tel\" name=\"telephone\" placeholder=\"Telephone\"><br><textarea rows=\"3\" cols=\"18\" name=\"comment\"></textarea><br><br><input type=\"submit\" name=\"FormSubmit\" placeholder=\"Question\"></form>', 1);
...
(1, 'admin', '', 'admin', 'admin', 'admin', '0', 1, 1),
